<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Order Process</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!--	<h5>Small</h5>
							...
							<br /> 
							<h5>Order</h5>
							<button type="button" class="btn btn-lg btn-primary">ADD Order</button>
							<button type="button" class="btn btn-lg btn-default">All Orders</button>
							<button type="button" class="btn btn-lg btn-success">Completed Orders</button>
							<button type="button" class="btn btn-lg btn-info">Orders In Progress</button>
