...
<?php $this->load->view('pichart'); ?>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<p class="back-link">Growel Infotech <a href="#">Power By GHEALTHTECH</a></p>
			</div>
		</div><!--/.row-->
	...
	<script src="<?php echo site_url('js/chart-data.js'); ?>"></script>
	<script src="<?php echo site_url('js/easypiechart.js'); ?>"></script>
	<script src="<?php echo site_url('js/easypiechart-data.js'); ?>"></script>
