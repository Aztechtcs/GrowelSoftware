<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Cutting Process</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Cutting Process</div>
					<div class="panel-body">
						...
						<!--	<h5>Small</h5>
							...
							<br /> 
							<h5>cutting</h5>
							<button type="button" class="btn btn-lg btn-primary">Add Today Cutting Record</button>
							<button type="button" class="btn btn-lg btn-default">History Cutting Record</button>
							<button type="button" class="btn btn-lg btn-success">Completed Orders</button>
							<button type="button" class="btn btn-lg btn-info">Cutting In Progress</button>
						...
						<div class="col-md-6" id="mid">
							<form role="form">
								<div class="form-group">
									...
									<input id="oid" class="form-control" placeholder="Order Style">
								</div>
                                                            <button type="button" id="add_order" class="btn btn-lg btn-primary">ADD Order</button>
								<!--<div class="form-group">
